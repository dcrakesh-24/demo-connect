        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            ...
            >
              ...
              <div className="absolute inset-6 border-2 border-[#1e3a5f] rounded-full" />
              
              {/* White circle */}
              <div className="absolute inset-12 bg-white rounded-full flex items-center justify-center shadow-lg">
                {/* Light blue rounded square with logo */}
                <div className="bg-gradient-to-b from-[#00d4ff] to-[#0088bb] rounded-xl p-8 shadow-xl flex items-center justify-center">
                  {data.companyLogo ? (
                    <img
              ...
              {/* Decorative dots positioned on outer dashed ring */}
              <div className="absolute top-1 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-[#00d4ff] rounded-full" />
              <div className="absolute bottom-1 left-1/2 -translate-x-1/2 translate-y-1/2 w-3 h-3 bg-orange-500 rounded-full" />
              <div className="absolute right-1 top-1/2 -translate-y-1/2 translate-x-1/2 w-3 h-3 bg-pink-500 rounded-full" />
            </div>
          </div>
        </div>
      </div>
