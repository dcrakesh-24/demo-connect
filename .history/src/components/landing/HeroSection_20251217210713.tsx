        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            ...
            >
              ...
              <div className="absolute inset-4 border-2 border-[#1e3a5f] rounded-full" />
              
              {/* White circle */}
              <div className="absolute inset-8 bg-white rounded-full flex items-center justify-center">
                {/* Light blue rounded square with logo */}
                <div className="bg-gradient-to-b from-[#00d4ff] to-[#0099cc] rounded-xl p-6 shadow-lg flex items-center justify-center">
                  {data.companyLogo ? (
                    <img
              ...
              {/* Decorative dots on outer dashed ring */}
              <div className="absolute top-2 left-1/2 -translate-x-1/2 w-3 h-3 bg-[#00d4ff] rounded-full" />
              <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-3 h-3 bg-orange-500 rounded-full" />
              <div className="absolute right-2 top-1/2 -translate-y-1/2 w-3 h-3 bg-pink-500 rounded-full" />
            </div>
          </div>
        </div>
      </div>
