      ...
      <div className="container mx-auto px-4 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            ...
            >
              {/* Inner dashed circle */}
              <div className="absolute inset-8 border-2 border-dashed border-white/50 rounded-full z-10" />
              
              {/* White circle */}
              <div className="absolute inset-12 bg-white rounded-full flex items-center justify-center shadow-lg z-20">
